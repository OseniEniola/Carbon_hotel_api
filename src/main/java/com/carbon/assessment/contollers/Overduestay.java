...
public class Overduestay {
    ...
    public ResponseEntity<Object> getOverstay(@PathVariable("customerId") Long id) throws GlobalException {
    ...
    public ResponseEntity<Object> createOverstay(@Valid @RequestBody Reservation reservation){
